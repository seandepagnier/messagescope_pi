...
class MessageScopeDialogBase : public wxDialog 
{
	...
	public:
		...
		MessageScopeDialogBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Message Scope"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 600,450 ), long style = wxCAPTION|wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER|wxTAB_TRAVERSAL ); 
