...
{
      AddLocaleCatalog( _T("opencpn-messagescope_pi") );
...
{
      return _T("Message Scope");
}


wxString messagescope_pi::GetShortDescription()
{
      return _("Message Scope PlugIn for OpenCPN");
}
...
bool messagescope_pi::LoadConfig(void)
{
    ...
    pConf->SetPath ( _T( "/Settings/messagescope" ) );
